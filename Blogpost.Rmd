...
all_features.lasso <- glmnet(X.train.all_features, y.train, alpha= 1, family = "binomial")

#selecting the optimal lambda with the lowest misclassification error
all_features.lasso_cv <- cv.glmnet(X.train.all_features, y.train, alpha = 1, type.measure = "class", 
